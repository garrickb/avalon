...
var _simon_larsson$elm_template$Data_Player$defaultPlayer = {username: ''};
var _simon_larsson$elm_template$Data_Player$Player = function (a) {
	return {username: a};
};
var _simon_larsson$elm_template$Data_Player$PlayerPresence = F2(
	function (a, b) {
		return {online_at: a, device: b};
	});

var _simon_larsson$elm_template$Data_Lobby$Lobby = F2(
	function (a, b) {
		return {name: a, socket: b};
	});

var _simon_larsson$elm_template$Data_Session$initialSession = {player: _elm_lang$core$Maybe$Nothing, lobby: _elm_lang$core$Maybe$Nothing};
var _simon_larsson$elm_template$Data_Session$Session = F2(
	function (a, b) {
		return {player: a, lobby: b};
	});
...
var _simon_larsson$elm_template$Route$Lobby = function (a) {
...
var _simon_larsson$elm_template$Route$routeMatcher = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_simon_larsson$elm_template$Route$Lobby,
					A2(
...
var _simon_larsson$elm_template$Layout_Page$viewFooter = A2(
...
var _simon_larsson$elm_template$Layout_Page$viewHeader = function (page) {
	return A2(
...
var _simon_larsson$elm_template$Layout_Page$layout = F2(
	function (page, content) {
		return A2(
			...
			{
				ctor: '::',
				_0: _simon_larsson$elm_template$Layout_Page$viewHeader(page),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
					...
					_1: {
						ctor: '::',
						_0: _simon_larsson$elm_template$Layout_Page$viewFooter,
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _simon_larsson$elm_template$Layout_Page$Lobby = {ctor: 'Lobby'};
var _simon_larsson$elm_template$Layout_Page$About = {ctor: 'About'};
var _simon_larsson$elm_template$Layout_Page$Home = {ctor: 'Home'};
var _simon_larsson$elm_template$Layout_Page$Other = {ctor: 'Other'};

var _simon_larsson$elm_template$Model_Dummy$Dummy = function (a) {
	return {name: a};
};

var _simon_larsson$elm_template$Page_About_Model$Model = F2(
	function (a, b) {
		return {pageTitle: a, pageBody: b};
	});

var _simon_larsson$elm_template$Page_About_Function$init = {pageTitle: 'About', pageBody: 'This is the aboutpage'};

var _simon_larsson$elm_template$Page_About_Message$Todo = {ctor: 'Todo'};

var _simon_larsson$elm_template$Page_About_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});

var _simon_larsson$elm_template$Page_About_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _simon_larsson$elm_template$Page_Home_Model$Model = F2(
	function (a, b) {
		return {username: a, lobbyname: b};
	});

var _simon_larsson$elm_template$Page_Home_Function$initWithName = function (defaultName) {
	return {username: defaultName, lobbyname: ''};
};
var _simon_larsson$elm_template$Page_Home_Function$init = {username: '', lobbyname: ''};

var _simon_larsson$elm_template$Page_Home_Message$LobbyName = function (a) {
	return {ctor: 'LobbyName', _0: a};
};
var _simon_larsson$elm_template$Page_Home_Message$UserName = function (a) {
	return {ctor: 'UserName', _0: a};
};
var _simon_larsson$elm_template$Page_Home_Message$JoinLobby = {ctor: 'JoinLobby'};

var _simon_larsson$elm_template$Page_Home_Update$SetPlayerLobby = F2(
	function (a, b) {
		return {ctor: 'SetPlayerLobby', _0: a, _1: b};
	});
var _simon_larsson$elm_template$Page_Home_Update$NoOp = {ctor: 'NoOp'};
var _simon_larsson$elm_template$Page_Home_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'JoinLobby':
				return {
					...
					_1: A2(
						_simon_larsson$elm_template$Page_Home_Update$SetPlayerLobby,
						_elm_lang$core$Maybe$Just(
							_simon_larsson$elm_template$Data_Player$Player(model.username)),
						_elm_lang$core$Maybe$Just(
							A2(_simon_larsson$elm_template$Data_Lobby$Lobby, model.lobbyname, _elm_lang$core$Maybe$Nothing)))
				};
			case 'UserName':
				return {
					ctor: '_Tuple2',
					...
					_1: _simon_larsson$elm_template$Page_Home_Update$NoOp
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _simon_larsson$elm_template$Page_Home_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_simon_larsson$elm_template$Page_Home_Message$UserName),
									_1: {
										ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('Lobby name'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_simon_larsson$elm_template$Page_Home_Message$LobbyName),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_simon_larsson$elm_template$Page_Home_Message$JoinLobby),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _simon_larsson$elm_template$Page_Lobby_Model$Model = {};

var _simon_larsson$elm_template$Page_Lobby_Function$init = {};

var _simon_larsson$elm_template$Page_Lobby_Message$Todo = {ctor: 'Todo'};

var _simon_larsson$elm_template$Page_Lobby_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});

var _simon_larsson$elm_template$Page_Lobby_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Lobby View'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('This is a lobby'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
if (typeof _simon_larsson$elm_template$Main$main !== 'undefined') {
    _simon_larsson$elm_template$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Route.Route":{"args":[],"tags":{"Home":[],"Lobby":["String"],"About":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Phoenix.Channel.State":{"args":[],"tags":{"Closed":[],"Joining":[],"Joined":[],"Leaving":[],"Errored":[]}},"Main.Msg":{"args":[],"tags":{"AboutMsg":["Page.About.Message.Msg"],"SetSession":["Data.Session.Session"],"SetRoute":["Maybe.Maybe Route.Route"],"HomeMsg":["Page.Home.Message.Msg"],"LobbyMsg":["Page.Lobby.Message.Msg"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Page.About.Message.Msg":{"args":[],"tags":{"Todo":[]}},"Page.Lobby.Message.Msg":{"args":[],"tags":{"Todo":[]}},"Page.Home.Message.Msg":{"args":[],"tags":{"LobbyName":["String"],"UserName":["String"],"JoinLobby":[]}},"Phoenix.Socket.Msg":{"args":["msg"],"tags":{"ChannelErrored":["String"],"ChannelClosed":["String"],"ExternalMsg":["msg"],"ChannelJoined":["String"],"Heartbeat":["Time.Time"],"NoOp":[],"ReceiveReply":["String","Int"]}}},"aliases":{"Phoenix.Push.Push":{"args":["msg"],"type":"{ event : String , channel : String , payload : Json.Encode.Value , onOk : Maybe.Maybe (Json.Encode.Value -> msg) , onError : Maybe.Maybe (Json.Encode.Value -> msg) }"},"Phoenix.Channel.Channel":{"args":["msg"],"type":"{ name : String , payload : Json.Encode.Value , state : Phoenix.Channel.State , onClose : Maybe.Maybe (Json.Encode.Value -> msg) , onError : Maybe.Maybe (Json.Encode.Value -> msg) , onJoin : Maybe.Maybe (Json.Encode.Value -> msg) , onJoinError : Maybe.Maybe (Json.Encode.Value -> msg) , joinRef : Int , leaveRef : Int }"},"Data.Lobby.Lobby":{"args":[],"type":"{ name : String , socket : Maybe.Maybe (Phoenix.Socket.Socket Phoenix.Socket.Msg) }"},"Data.Session.Session":{"args":[],"type":"{ player : Maybe.Maybe Data.Player.Player , lobby : Maybe.Maybe Data.Lobby.Lobby }"},"Phoenix.Socket.Socket":{"args":["msg"],"type":"{ path : String , debug : Bool , channels : Dict.Dict String (Phoenix.Channel.Channel msg) , events : Dict.Dict ( String, String ) (Json.Encode.Value -> msg) , pushes : Dict.Dict Int (Phoenix.Push.Push msg) , ref : Int , heartbeatIntervalSeconds : Float , withoutHeartbeat : Bool }"},"Data.Player.Player":{"args":[],"type":"{ username : String }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
